    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="modal fade" id="modal-lg" aria-hidden="true" style="display: none;">
                <form method="post" action="mesin_tambah_berita.php" enctype="multipart/form-data">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a class="btn btn-info" href="mesin_hapus_berita.php?id=<?php echo $data['id']; ?>">Hapus</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            include "koneksi.php";
                                            $id = $data['id'];
                                            $query_edit = mysqli_query($koneksi, "SELECT * FROM berita where id='$id'");
                                            while ($row = mysqli_fetch_array($query_edit)) {
                                            ?>

                                                <div class="modal fade" id="modal-edit<?php echo $data['id']; ?>" aria-hidden="true" style="display: none;">
                                                    <form method="post" action="mesin_edit_berita.php" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="card card-primary">
                                                                        <div class="card-body">
                                                                            <div class="form-group">
                                                                                <label for="exampleInputEmail1">Judul berita</label>
                                                                                <input type="text" class="form-control" name="judul" value="<?php echo $row['judul_berita']; ?>">
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="exampleInputPassword1">Deskripsi</label>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <img src="gambar/<?= $row['gambar'] ?>" width="50" height="500">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
