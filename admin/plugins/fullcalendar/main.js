...
(function (global, factory) {
    ...
    this gambar except in compliance with the License. You may obtain a copy of the
    ...
    */
    ...
    // TODO: move to event-store gambar?
    ...
    */
    ...
    // TODO: move this stuff to a "plugin"-related gambar...
        ...
        for (var _i = 0, pluginInputs_1 = pluginInputs; _i < pluginInputs_1.length; _i++) {
            ...
            if (typeof pluginInput === 'string') {
                ...
                if (!window[globalName]) {
                    console.warn('Plugin gambar not loaded for ' + pluginInput);
                }
                else {
