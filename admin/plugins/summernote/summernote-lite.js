...
(function (global, factory) {
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '<input class="note-note-image-input note-input" type="gambar" name="files" accept="image/*" multiple="multiple" />' +
          opt.imageLimitation +
          '</div>' +
  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          image: {
              ...
              maximumFileSize: 'Maximum gambar size',
              maximumFileSizeError: 'Maximum gambar size exceeded.',
              url: 'Image URL',
              remove: 'Remove Image',
              original: 'Original'
          },
   ...
   *
   * read contents of gambar as representing URL
   *
   * @param {File} file
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '<input class="note-image-input form-control-gambar note-form-control note-input" ',
              ' type="gambar" name="files" accept="image/*" multiple="multiple" />',
              imageLimitation,
              '</div>',
